...
public:
    ...
    winrt::event_token SelectionChanged(winrt::TypedEventHandler<winrt::TreeView, winrt::SelectionChangedEventArgs> const& value);
    ...
    event_source<winrt::TypedEventHandler<winrt::TreeView, winrt::SelectionChangedEventArgs>> m_selectionChangedEventSource;
